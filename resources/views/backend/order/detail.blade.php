...
<div class="row">
  <div class="col-lg-12">
      <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
          <li class="breadcrumb-item active font-weight-bold" aria-current="page"><a href="{{route('order.byday')}}"> Orders</a></li>
              <li class="breadcrumb-item active font-weight-bold" aria-current="page">Orders Details</li>
          </ol>
      </nav>
  </div>
</div>
        ...
        <div class="card border-left-warning shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
              <div class="text-xs font-weight-bold text-success text-uppercase mb-1">{{'Bàn: ' . $order->table}}</div>
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800">{{number_format($order->total_price) . '  VNĐ'}} </div>
              </div>
              <div class="col-auto">
              <a href="{{ route('printbill', ['id' => $order->id])}}"> <i class="fas fa-print fa-2x .bg-gradient-success"></i></a>
              </div>
            </div>
          </div>
        </div>
